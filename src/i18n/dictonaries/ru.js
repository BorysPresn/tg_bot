module.exports = {
  ...
  phone_question:
    "Введите номер телефона:\n{length} цифр без пробелов (например: 500600700)\n\n(или используйте кнопку внизу, чтобы поделиться контактом)",
  ...
  phone_error:
    "Номер телефона должен содержать ровно {length} цифр (без пробелов).",
  car_name_error:
  ...
  vin_error:
    "VIN должен содержать {min} символов и не включать буквы I, O и Q.",
  ...
  send_contact_btn: "📞 Отправить мой номер телефона",
